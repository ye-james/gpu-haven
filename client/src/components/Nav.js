      ...
      <div className="flex items-center flex-shrink-0 mr-6 text-primary-gray">
        ...
        <div className="block lg:hidden">
            <button className="flex items-center px-3 py-2 border border-white rounded text-primary-gray border-primary-gray hover:text-white hover:">
                <svg className="w-3 h-3 fill-primary-gray" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
            </button>
        </div>
        <div className="block w-full flew-grow lg:flex lg:items-center lg:w-auto">
            ...
            <Link to="cart" className="inline-block px-4 py-2 mt-4 text-sm text-lg font-medium leading-none border rounded text-primary-gray border-text-primary-gray hover:border-transparent hover:text-primary-dark hover:bg-secondary-light lg:mt-0"><i className='fa fa-shopping-cart'/></Link>
        </div>
    </nav>
  )
}
